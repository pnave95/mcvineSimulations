...
def results(ifile, E_i):
	...
	for bank in range(115):
		...
		#for e in range(10):	
			...
			InstrumentCartesian[0] = X
			InstrumentCartesian[1] = Y
			InstrumentCartesian[2] = Z
