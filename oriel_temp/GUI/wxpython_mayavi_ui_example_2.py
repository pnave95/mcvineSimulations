...
class MainWindow(wx.Frame):
    ...
    #def __init__(*args, **kwargs):
        ...
        #self.notebook.AddPage(page=self.control, caption='Display 1', text='some text')
        self.notebook.AddPage(page=self.control, text='Display 1')
        ...
        self.notebook.AddPage(page=self.control2, text='Display 2')
